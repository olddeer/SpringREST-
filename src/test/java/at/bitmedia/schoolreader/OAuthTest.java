...
private String obtainAccessToken(String username,String password) throws Exception{
    ...
    ResultActions result
            ...
            .params(params)
            .with(httpBasic("spring-security-oauth2-read-write-client","spring-security-oauth2-read-write-client-password1234"))
  ...
  /*  @Test
    public void testAll()throws Exception{
        ...
        moc.perform(get("http://localhost:8080/secured/tasks/all").contentType(MediaType.APPLICATION_JSON).header("Authorization", "Bearer " + accessToken))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andDo(print())
